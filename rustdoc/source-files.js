...
sourcesIndex["difflib"] = {"name":"","files":["differ.rs","lib.rs","sequencematcher.rs","utils.rs"]};
...
sourcesIndex["kstring"] = {"name":"","files":["cow.rs","inline.rs","lib.rs","ref.rs","string.rs"]};
...
sourcesIndex["tracing_subscriber"] = {"name":"","dirs":[{"name":"field","files":["debug.rs","delimited.rs","display.rs","mod.rs"]},{"name":"filter","dirs":[{"name":"env","files":["directive.rs","field.rs","mod.rs"]},{"name":"layer_filters","files":["combinator.rs","mod.rs"]}],"files":["directive.rs","filter_fn.rs","level.rs","mod.rs","targets.rs"]},{"name":"fmt","dirs":[{"name":"format","files":["json.rs","mod.rs","pretty.rs"]},{"name":"time","files":["datetime.rs","mod.rs"]}],"files":["fmt_layer.rs","mod.rs","writer.rs"]},{"name":"layer","files":["context.rs","layered.rs","mod.rs"]},{"name":"registry","files":["extensions.rs","mod.rs","sharded.rs","stack.rs"]}],"files":["lib.rs","macros.rs","prelude.rs","reload.rs","sync.rs","util.rs"]};
sourcesIndex["trycmd"] = {"name":"","files":["cargo.rs","cases.rs","color.rs","command.rs","diff.rs","elide.rs","error.rs","filesystem.rs","lib.rs","lines.rs","macros.rs","registry.rs","runner.rs","schema.rs","spec.rs"]};
